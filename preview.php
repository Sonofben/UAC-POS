...
?>   
			...
			<li <?=$hidelink?> ><a href="sales_inventory.php"><i class="icon-table icon-2x"></i> Product Inventory</a>                </li>
				<br>		
			<li>
...
<div style="margin: 0 auto; padding: 10px; width: 600px; font-weight: normal;">
...
Lagos, Nigeria	<br>	<br>
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="90%">
		<thead>
			<tr>
				<th width="89"> Product Code </th>
				<th width="173"> Product Name </th>
				<th width="102"> Qty </th>
