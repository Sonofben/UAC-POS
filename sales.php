...
?> 
			...
			<form name="clock">
			<font color="white">Time: <br></font>&nbsp;<input style="width:100px;" type="text" class="trans" name="face" value="" disabled>
			</form>
			  </div>
			</li>
...
<script>
function Clickrefresh2()
{ 
  window.parent(location="sales.php?id=cash&invoice=<?php echo $_GET['invoice']; ?>");
}
</script>

<div style="float:right;">
<a  onClick="return Clickrefresh2();"><button  style="float:right;" title="Refresh Product" class="btn btn-success btn-mini">Refresh</button></a>
</div>
...
<table class="table table-bordered" id="resultTable" data-responsive="table">
	...
	<tbody>
            ...
            <script>
			function confirm_sales_del(){
				if(confirm("Are you sure want to delete selected Sales? There is NO undo!"))
		  {
			  return true;
            ...
            <a onClick="return confirm_sales_del();" href="delete.php?id=<?php echo $row['transaction_id']; ?>&invoice=<?php echo $_GET['invoice']; ?>&dle=<?php echo $_GET['id']; ?>&qty=<?php echo $row['qty'];?>&code=<?php echo $row['product'];?>"><button class="btn btn-mini btn-warning"><i class="icon icon-remove"></i> Cancel </button></a></td>
			</tr>
			<?php
				}
			?>
