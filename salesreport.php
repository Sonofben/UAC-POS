...
{ 
  window.parent(location="salesreport.php?d1=0&d2=0");
}
</script>
...
<a onClick="return Clickheretoprint();"><button  style="float:right;" class="btn btn-success btn-mini">Print</button></a>
<a onClick="return Clickrefresh();"><button  style="float:right;" class="btn btn-success btn-mini">Refresh</button></a>

</div>
<form action="salesreport.php" method="get">
<center><strong>From : <input type="text" style="width: 223px; height: 30px; padding:5px;" name="d1" class="tcal" value="" /> To: <input type="text" style="width: 223px; height: 30px; padding:5px;" name="d2" class="tcal" value="" />
...
<center><div style="font:bold 25px 'Aleo';"><strong>Customer Sales Report</strong></div>
